...
const SignUpPage = () => {
  ...
  const { user, register, error, loading, loadUser } = useAuth();
  ...
  const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
    ...
    try {
      await register(registerInstance);
      await loadUser();
    } catch (error) {
      console.error(error);
    }
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className={cn(
                        form.formState.errors.first_name && 'border-red-400 focus-visible:ring-red-400',
                        'pr-8'
                      )}
                    />
                  </FormControl>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className={cn(
                        form.formState.errors.last_name && 'border-red-400 focus-visible:ring-red-400',
                        'pr-8'
                      )}
                    />
                  </FormControl>
